 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/pd/medstoYpthzd")
public class MedstoYpthzdController extends BaseController {
	...
	@RequiresPermissions("pd:medstoYpthzd:view")
	...
	public String list(MedstoYpthzd medstoYpthzd, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "hys/pd/pdDrugRefundList";
	}
	...
	public String form(MedstoYpthzd medstoYpthzd, Model model) {
		...
		return "hys/pd/medstoYpthzdForm";
	}
	//同步到中心平台
	@RequestMapping(value = "upload")
	public String upload(MedstoYpthzd medstoYpthzd, Model model, RedirectAttributes redirectAttributes) {
		//更改状态并同步数据
		medstoYpthzdService.uploadData(medstoYpthzd);
		addMessage(redirectAttributes, "上传成功");
		return "redirect:"+Global.getAdminPath()+"/pd/medstoYpthzd/?repage";
	}

	@RequiresPermissions("pd:medstoYpthzd:edit")
