...
public class MedstoYpbsdExcel {
    ...
    @ExcelField(title="报损数量",sort=260,align=2)
    private String damagenumber;		// 报损数量
    @ExcelField(title="报损日期",sort=270,align=2)
    private String damagedatetime;		// 报损日期
    @ExcelField(title="报损原因",sort=280,align=2)
    ...
    public String getDamagedatetime() {
        return damagedatetime;
    }

    public void setDamagedatetime(String damagedatetime) {
