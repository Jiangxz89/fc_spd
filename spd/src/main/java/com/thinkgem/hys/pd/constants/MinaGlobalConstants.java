package com.thinkgem.hys.pd.constants;
...
public class MinaGlobalConstants {
	...
	public final static String IS_CHARGE_2 = "2";//取消收费
	public final static String IS_CHARGE_3 = "3";//退回库存
...
*/	
	...
	public static final String STOCK_TO_NUM = "1";    //库存大于0过滤标识
}
