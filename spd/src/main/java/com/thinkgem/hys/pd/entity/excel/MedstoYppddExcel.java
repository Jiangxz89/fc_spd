...
public class MedstoYppddExcel {
    ...
    @ExcelField(title="盘点库房",sort=280,align=2)
    private String inventorystorage;		// 盘点库房
    @ExcelField(title="库存数量",sort=290,align=2)
    private String storagenumber;		// 库存数量
    @ExcelField(title="盘点数量",sort=300,align=2)
    private String inventorynumber;		// 盘点数量
    @ExcelField(title="药品默认扣率",sort=310,align=2)
    private String ypmrkl;		// 药品默认扣率
    @ExcelField(title="上传日期",sort=320,align=2)
