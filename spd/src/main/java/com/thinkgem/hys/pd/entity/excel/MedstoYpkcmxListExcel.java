...
public class MedstoYpkcmxListExcel {
    ...
    @ExcelField(title="药品编码",sort=40,align=2)
    private String drugId;		// 药品编码
    @ExcelField(title="医保统一编码",sort=50,align=2)
    private String ybtybm;		// 医保统一编码
    @ExcelField(title="是否基药",sort=60,align=2)
    private String isjbyw;		// 是否基药
    @ExcelField(title="是否抗生素药品",sort=70,align=2)
    private String kss;		// 是否抗生素药品
    @ExcelField(title="中药使用类别代码",sort=80,align=2)
    private String cmedCode;		// 中药使用类别代码
    @ExcelField(title="药物类型",sort=90,align=2)
    private String drugDetailType;		// 药物类型
    @ExcelField(title="药物剂型代码",sort=100,align=2)
    private String doseCode;		// 药物剂型代码
    @ExcelField(title="药品名称",sort=120,align=2)
    private String drugName;		// 药品名称
    @ExcelField(title="药品规格",sort=130,align=2)
    private String drugSpec;		// 药品规格
    @ExcelField(title="大包装单位",sort=140,align=2)
    private String packageUnit;		// 大包装单位
    @ExcelField(title="大包装数量",sort=150,align=2)
    private String packageQty;		// 大包装数量
    @ExcelField(title="小包装单位",sort=160,align=2)
    private String salesUnit;		// 小包装单位
    @ExcelField(title="小包装数量",sort=170,align=2)
    private String salesQty;		// 小包装数量
    @ExcelField(title="包装单位数量关系",sort=180,align=2)
    private String salesRelation;		// 包装单位数量关系
    @ExcelField(title="供货商名称",sort=190,align=2)
    private String producerName;		// 供货商名称
    @ExcelField(title="进价单价",sort=200,align=2)
    private String costPrice;		// 进价单价
    @ExcelField(title="零售单价",sort=210,align=2)
    private String salePrice;		// 零售单价
    @ExcelField(title="进价金额合计",sort=220,align=2)
    private String costAmt;		// 进价金额合计
    @ExcelField(title="零售金额合计",sort=230,align=2)
    private String saleAmt;		// 零售金额合计
    @ExcelField(title="生产批号",sort=240,align=2)
    private String batchNo;		// 生产批号
    @ExcelField(title="药品生产企业",sort=250,align=2)
    private String sdrugmanufacturers;		// 药品生产企业
    @ExcelField(title="药品产地",sort=260,align=2)
    private String sdrughabitat;		// 药品产地
    @ExcelField(title="批准文号",sort=270,align=2)
    private String sratificationno;		// 批准文号
    @ExcelField(title="生产日期",sort=280,align=2)
    private String ddateproduce;		// 生产日期
    @ExcelField(title="失效日期",sort=290,align=2)
