 ...
 * @version 2019-09-20
 */
public class DataMasterpan extends DataEntity<DataMasterpan> {
	...
	private String ykdid;		// 审核时间
	
	public DataMasterpan() {
		super();
	}

	public DataMasterpan(String id){
		super(id);
	}
	...
	@Length(min=1, max=11, message="审核时间长度必须介于 1 和 11 之间")
	public String getYkdid() {
		return ykdid;
	}

	public void setYkdid(String ykdid) {
		this.ykdid = ykdid;
	}
