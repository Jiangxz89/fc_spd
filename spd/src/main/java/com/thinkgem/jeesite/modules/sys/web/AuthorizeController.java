...
import com.thinkgem.jeesite.common.config.Oauth2Constants;
import com.thinkgem.jeesite.common.config.Global;
import com.thinkgem.jeesite.modules.sys.security.UsernamePasswordToken;
import com.thinkgem.jeesite.modules.sys.service.auth.OAuthService;
...
public class AuthorizeController {
    ...
    public Object  authorize(Model model,HttpServletRequest request)throws URISyntaxException, OAuthSystemException {
        ...
        try {
         ...
         client_id:客户端ID（必选项）
                       例如：
         http://localhost:8082/huicy/authorize?
         client_id=c1ebe466-1cdc-4bd3-ab69-77c3561b9dee
         &response_type=code
         &redirect_uri=http://localhost:8082/huicy/XX
         */   
       	 OAuthAuthzRequest oauthRequest = new OAuthAuthzRequest(request);

         //检查传入的客户端id是否正确
          if (!oAuthService.checkClientId(oauthRequest.getClientId())) { //如果客户端不存在
            ...
            if (responseType.equals(ResponseType.CODE.toString())) {
                ...
                //保存 code  和 username 的关联关系
                oAuthService.addAuthCode(authorizationCode, username);
            }

            return "forward:/accessToken?code="+authorizationCode;
            /*//进行OAuth响应构建 --------------------------返给客户端 code-----------------------------------
