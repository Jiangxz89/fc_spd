...
public class TestDemo {
	 ...
	 public static void main(String[] args) throws BeansException {
	        ApplicationContext ctx = new ClassPathXmlApplicationContext("spring-context-quartz.xml");  
	        ...
	        try {  
	            ...
	            quartzManager.addJob("test", "test", "test", "test", QuartzJobExample.class, "0/1 * * * * ?");    
