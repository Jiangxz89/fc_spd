...
import com.easemob.im.api.impl.EasemobIMUsers;
...
public class UserTest {
    ...
    public void createUser() {
        ...
        User user = new User().username("hcy" + new Random().nextInt(500)).password("123456");
        User user1 = new User().username("hcy" + new Random().nextInt(500)).password("123456");
        users.add(user);
        users.add(user1);
