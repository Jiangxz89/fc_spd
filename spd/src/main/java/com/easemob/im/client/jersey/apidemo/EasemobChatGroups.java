package com.easemob.im.client.jersey.apidemo;
...
import com.easemob.im.client.jersey.utils.JerseyUtils;
import com.easemob.im.client.jersey.vo.Credential;
import com.easemob.im.client.jersey.vo.EndPoints;
...
public class EasemobChatGroups {
    ...
    private static Credential credential = new com.easemob.im.client.jersey.vo.ClientSecretCredential(Constants.APP_CLIENT_ID,
	...
	public static ObjectNode getAllChatgroupids() {
		...
		try {
			...
			JerseyWebTarget webTarget = com.easemob.im.client.jersey.vo.EndPoints.CHATGROUPS_TARGET.resolveTemplate("org_name", APPKEY.split("#")[0])
