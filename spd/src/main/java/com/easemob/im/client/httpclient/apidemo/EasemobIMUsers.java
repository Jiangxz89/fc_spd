package com.easemob.im.client.httpclient.apidemo;
...
import com.easemob.im.client.comm.Constants;
import com.easemob.im.client.comm.HTTPMethod;
import com.easemob.im.client.comm.Roles;
import com.easemob.im.client.httpclient.utils.HTTPClientUtils;
import com.easemob.im.client.httpclient.vo.ClientSecretCredential;
import com.easemob.im.client.httpclient.vo.Credential;
import com.easemob.im.client.httpclient.vo.EndPoints;
...
public class EasemobIMUsers {
	 ...
	 * @return
	 */
	public static ObjectNode imUserLoginOut(String username) {
		...
		try {
			...
			dataNode.put("grant_type", "password");
			dataNode.put("username", username);
			objectNode = HTTPClientUtils.sendHTTPRequest(EndPoints.LOGINOUT_APP_URL, null, dataNode,
					HTTPMethod.METHOD_POST);
		} catch (Exception e) {
			throw new RuntimeException("Some errors occurred while fetching a token by username and password .");
		}
