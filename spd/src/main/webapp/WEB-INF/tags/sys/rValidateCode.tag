...
<div style="float:left;width:118px;height:33px;" onclick="$('.${name}Refresh').click();"><img src="${ctxcbp}/validateCode/doGet?module=${module}" onclick="$('.${name}Refresh').click();" class="mid ${name}" style="${imageCssStyle}"/></div>
<a href="javascript:" onclick="$('.${name}').attr('src','${ctxcbp}/validateCode/doPost?module=${module}&'+new Date().getTime());" class="mid ${name}Refresh" style="${buttonCssStyle}"></a>