...
<head>
	...
	<link rel="stylesheet" href="${ctxStatic}/hcy/css/base.css">
	<style>
		.control-group .controls>input[type='text']{width:160px;height:28px;border:1px solid #ccc;margin:0;}
	</style>
...
<body>
	...
	<form:form id="inputForm" modelAttribute="dict" action="${ctx}/sys/dict/save" method="post" class="form-horizontal">
		...
		<div class="form-actions" style="text-align:center;background:#fff;border-top:0;">
			<shiro:hasPermission name="sys:dict:edit"><input id="btnSubmit" class="hcy-btn hcy-btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
			<input id="btnCancel" class="hcy-btn" type="button" value="返 回" onclick="history.go(-1)"/>
		</div>
	</form:form>
</body>
</html>