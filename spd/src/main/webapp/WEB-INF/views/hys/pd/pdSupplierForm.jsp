...
<head>
	...
	<style>
		.showpic{height: 20px;line-height: 20px; text-align: right; padding-right: 20px;font-size: 13px;color: #00CFA5; padding-top: 4px;cursor: pointer;}
		...
		.showpic{cursor:pointer;color:#666;}
		.smallImg img{position:relative;z-index:666;}
	</style>
...
<body>
	<div class="right-main-box"> 
		<%--<div class="btnBox" style="border-bottom:1px solid #ccc">
			<h4 style="padding:0;">供应商信息添加</h4>
		</div>--%>
	<form:form id="inputForm" style="padding-top:20px;" modelAttribute="pdSupplier" enctype="multipart/form-data" action="${ctx}/pd/pdSupplier/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group addProductBox" style="padding-bottom:20px;">
			...
			<%--<div class="controls" style="margin:0;">--%>
				<%--<form:input path="supplierName" htmlEscape="false" required="required" style="height: 30px;border-radius: 2px;padding: 0 0 0 5px;" maxlength="100" class="input-xlarge required"/>--%>
			<%--</div>--%>
			<%--<label class="control-label"><span class="mustIcon">*</span>拼音简码</label>--%>
			<%--<div class="controls" style="margin:0;">--%>
				<%--<form:input path="pinyin" htmlEscape="false" required="required" style="height: 30px;border-radius: 2px;padding: 0 0 0 5px;" maxlength="100" class="input-xlarge required"/>--%>
			<%--</div>--%>

			<label for=""><span class="mustIcon">*</span>供应商名称：</label>
			<input type="text" class="createInp" style="width:300px;height:30px;border:1px solid #ccc;" autocomplete="off" name="supplierName" value="${pdSupplier.supplierName }" required/>
			<label for=""><span class="mustIcon">*</span>拼音简码</label>
			<input type="text" class="createInp" style="width:300px;height:30px;border:1px solid #ccc;" autocomplete="off" name="pinyin" value="${pdSupplier.pinyin }" required/><br />
		</div>
	...
	<script type="text/javascript">
			...
			function sub(){
				if($("#supplierName").val()!=""){
					...
					$("#inputForm").attr("action","${ctx}/pd/pdSupplier/save?flag="+$("[name=flag]").val());
					return true;
				}
			}
