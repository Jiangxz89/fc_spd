...
<body>
	<div class="right-main-box"> 
		...
		<div class="searchBox">
			<form:form id="searchForm" modelAttribute="medstoYppdd" action="${ctx}/pd/medstoYppdd/findDrugInventoryDetailed" method="post" class="breadcrumb form-search">
	...
	<script type="text/javascript">
		$(function() {
			...
			$('#exportBtn').one('click',function(){
				...
				form.attr('action', '${ctx}/excelExport/drugInventoryDetailedExport');
				var input = $('<input>');
