...
<body>
	<div class="right-main-box">
		<div class="btnBox">
			<h4>出库管理</h4>
			<c:if test="${not empty fns:getUser().storeroomType }">
			<a href="${ctx}/pd/pdStockRecord/formOut" class="hcy-btn hcy-btn-primary">新增出库</a>
			</c:if>
		</div>	
		<div class="newSearchBox">
			<form:form id="searchForm" modelAttribute="pdStockRecord" action="${ctx}/pd/pdStockRecord/outList" method="post" class="breadcrumb form-search">
