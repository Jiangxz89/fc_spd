...
<body>
	<div class="right-main-box">
		...
		<div class="newSearchBox">
			<form:form id="searchForm" modelAttribute="pdStockRecord" action="${ctx}/pd/pdStockRecord/pdStockRecordOutDtlQuery" method="post" class="breadcrumb form-search">
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$('#exportBtn').one('click',function(){
				...
				form.attr('action', '${ctx}/excelExport/stockRecordOutDtlQueryExport');
				var input = $('<input>');
