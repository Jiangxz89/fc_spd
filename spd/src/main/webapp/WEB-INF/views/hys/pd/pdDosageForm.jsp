...
<head>
	...
	<style>
		...
		.addRoomBox label{width:85px;display: inline-block;text-align: left;font-size:12px;}
...
<div class="right-main-box">
	...
	<form:form id="inputForm" style="padding:0;" modelAttribute="pdDosage" action="${ctx}/pd/pdDosage/save" method="post" class="form-horizontal">
		...
		<div id="chargingSelect" class="addRoomBox">
			<h4>收费信息（请输入住院号，按回车查询病人信息）</h4>
			<label for="">住院号</label>
			<input type="text" autocomplete="off" style="width:165px;"  id="inHospitalNoInputN"/>
			<label for="">就诊流水号</label>
			<input type="text" autocomplete="off" name="visitNo" style="width:165px;"  id="operativeNumberInput" readonly="readonly"/>
			<label for="">住院标识</label>
			<input type="text" autocomplete="off" style="width:165px;"  id="zyType" readonly="readonly"/>
			</br>
			<label for="">病人姓名</label>
			<input type="text" name="patientInfo" id="patientInfo" style="width:165px;" readonly="readonly"/>
			<label for="">住院号</label>
			<input type="text" name="inHospitalNo" style="width:165px;" readonly="readonly" id="inHospitalNoHInput"/>
			<label for="">门诊号</label>
			<input type="text" name="outpatientNumber" id="outpatientNumber" style="width:165px;" readonly="readonly"/>
			</br>
			<label for="">所属科室</label>
			<input type="text" name="exeDeptName" id="exeDeptName" style="width:165px;" readonly="readonly"/>
			<input type="hidden" name="exeDeptId" id="exeDeptId"  style="width:165px;" readonly="readonly"/>
			<label for="">所属病区</label>
			<input type="text"  name="subordinateWard" id="subordinateWardIn" style="width:165px;" readonly="readonly"/>
			<input type="hidden" name="subordinateWardId" id="subordinateWardIdIn" style="width:165px;" readonly="readonly"/>
			<label for="">申请医生姓名</label>
			<input type="text" name="sqrtDoctor" id="sqrtDoctor" style="width:165px;" readonly="readonly"/>
			<input type="hidden" name="sqrtDoctorId" id="sqrtDoctorId" style="width:165px;" readonly="readonly"/>
			<br />
			<label for="">手术编号</label>
			<input type="text"  name="operativeNumber" style="width:165px;" readonly="readonly" id="operativeNumberHInput"/>
			<label for="">手术科室</label>
			<input type="text" name="oprDeptName" id="oprDeptName" style="width:165px;" readonly="readonly"/>
			<input type="hidden" name="oprDeptId" id="oprDeptId" style="width:165px;" readonly="readonly"/>
			<label for="">手术名称</label>
			<input type="text" name="operativeName" id="operativeName" style="width:165px;" readonly="readonly"/>
			<br />
			<!-- 模拟数据用 -->
		...
		<div id="implementDiv" class="checkChargeDiv">
			...
			<span style="font-size:14px">执行收费</span>
