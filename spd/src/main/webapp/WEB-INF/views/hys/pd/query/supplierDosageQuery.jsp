...
<body>
	<div class="right-main-box"> 
		<div class="btnBox">
			<h4>供应商用量查询</h4>
			<%--<a class="hcy-btn hcy-btn-primary" href="###">导出Excel</a>--%>
		</div>
			<form:form id="searchForm" modelAttribute="pdDosage" action="${ctx}/pd/pdDosage/supplierDosageQuery" method="post" class="breadcrumb form-search">
...
<%-- 				<div>
				...
				<label>产品规格 </label>
				<form:input path="spec" autocomplete="off" value="${pdDosage.spec}"/>
				<label>产品批号</label>
