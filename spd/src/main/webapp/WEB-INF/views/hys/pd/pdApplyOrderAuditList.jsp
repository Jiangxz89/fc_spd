...
<body>
	<div class="right-main-box">
		...
		<form:form id="searchForm" style="padding:0;background:#fff;" modelAttribute="pdApplyOrder" action="${ctx}/pd/pdApplyOrder/auditList" method="post" class="breadcrumb form-search">
			...
			<div class="searchBox">
				...
				<div>
					...
					<input type="text" id="getTime" autocomplete="off" name="queryDate" style="width:160px;" value="${pdApplyOrder.queryDate }"/>
				</div>
				...
				<tbody>
					<c:forEach items="${page.list }" var="li">
						<tr>
							...
							<td>${li.applyCount }</td>
							<td>${li.applyName }</td>
							<td><a href="${ctx}/pd/pdApplyDetail/form?applyNo=${li.applyNo}" class="hcy-btn hcy-btn-o">查看</a>
							<a href="${ctx}/pd/pdApplyOrder/auditForm?id=${li.applyNo}" class="hcy-btn hcy-btn-o">审核</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
