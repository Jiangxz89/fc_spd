...
<body>
	<div class="right-main-box">
		<div class="searchBox">
			<form:form id="searchForm" modelAttribute="pdAllocationRecord" method="post" action="${ctx}/pd/pdAllocationRecord/addAllocationInBox">
				...
				<div>
					<label>调拨单号</label>
					<form:input path="allocationCode" htmlEscape="false" maxlength="64" class="input-medium"/>
				</div>
					<div><label>申请日期</label>
						<form:input path="queryDate" htmlEscape="false" id="allotTime" style="width:160px;" readonly="readonly" maxlength="64" class="input-medium" value="${pdAllocationRecord.queryDate}"/>
					</div>			
